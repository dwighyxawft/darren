...
if(typeof(loggedIn) == undefined || loggedIn == "false" || !loggedIn){
    ...
    var first = [{p_code:"KIWMZKLUX", r_date: "2023/01/01", p_date: "2023/01/02", amount: "7,500", status: "Deposit"}, {p_code:"VLXVXEYGI", r_date: "2023/02/02", p_date: "2023/02/03", amount: "7,500", status: "Deposit"}, {p_code:"PNDHLCBHY", r_date: "2023/03/04", p_date: "2023/03/06", amount: "7,500", status: "Deposit"}, {p_code:"ERTTBZASK", r_date: "2023/04/07", p_date: "2023/04/09", amount: "7,500", status: "Deposit"}];
